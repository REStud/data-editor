...
- *** You collected your data *** You may want to release the data in a separte record, but if not, please include all survey or experimental instruments, even if you included them in an online appendix. Online appendices do not have a DOI, therefore by including them in the replication package they will have a permanent home with a DOI, a reuse license, allowing readers to cite them and to access them.
