...
# Hero section
title: Data Availability Policy and Guidance
description: The Review's data and code availability policy and practical guidance for preparing your replication package.
...
.dcas-panel { border: 1px solid #e2e2e2; border-radius: 4px; margin-bottom: .5rem; overflow: hidden; }
...
This page brings together everything you need to know about the Review's data and code availability requirements. It has two parts: **Part 1** describes the [Data Availability Policy](#the-data-availability-policy) you accept when you submit, and **Part 2** provides [practical guidance](#preparing-your-replication-package) on how to prepare and submit your replication package once your paper is accepted.
...
After your paper has been accepted (or sometimes during the revision process), you will be asked by the Managing Editor to submit your replication package. The instructions below ensure that your replication package meets the DCAS requirements described in Part 1. If you have any questions about the submission process, please contact the [Data Editor]({{ site.baseurl }}/editor/).
